...
目前，CSR生成工具非常多，比如openssl工具，keystore explore，XCA等，比如[trustAsia在线工具](https://myssl.com/csr_create.html)， [DigiCert OpenSSL CSR Wizard](https://www.digicert.com/easy-csr/openssl.htm) 。 这里还是继续采用openssl工具创建CSR
